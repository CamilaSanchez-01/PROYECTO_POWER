...
// Exponer funciones globalmente para Google Apps Script
if (typeof window !== 'undefined') {
  window.agruparSalonesPorEdificio = agruparSalonesPorEdificio;
  window.mostrarSalonesEnInterfaz = mostrarSalonesEnInterfaz;
  window.mostrarMensajeAcomodamiento = mostrarMensajeAcomodamiento;
  window.mostrarSeccionGruposDivididos = mostrarSeccionGruposDivididos;
  window.mostrarMensajeSinGruposDivididos = mostrarMensajeSinGruposDivididos;
}